...
const services = [
  {
    title: 'Dry Needling Terapêutico',
    description: 'Técnica fisioterapêutica que utiliza agulhas filiformes para desativação de pontos gatilho miofasciais, redução da dor muscular, melhora da mobilidade e restauração da função. Procedimento realizado após avaliação fisioterapêutica individual.',
    icon: <Zap className="w-6 h-6" />,
    tag: 'Performance'
  },
  {
    title: 'Prevenção de Lesões',
    description: 'Foca em evitar dores ou problemas antes que eles apareçam. Por meio de avaliação individual, identificando desequilíbrios e orientando exercícios e cuidados tornando o movimento mais seguro e o corpo mais forte.',
